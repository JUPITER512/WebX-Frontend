...
const Header = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const userImage = useRecoilValue(UserData('profilePicture'))
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none  dark:border-b-[1px]">
      <div className="flex flex-grow items-center justify-between px-4 py-4 lg:p-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center justify-center gap6">
          ...
          <img src="./logo-no-background.png" className="w-32 ml-2 dark:invert " alt="logo" />
        </div>
